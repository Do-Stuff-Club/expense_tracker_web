...
test('TagChip renders its label with a randomized background color if no color is specified', () => {
    render(<TagChip key={0} label='hello' />);
...
test('TagChip renders its label with the same color for tags with the same string', () => {
